...
- ""
date: "2021-11-28"
description: Data science. # the title that will show up once someone gets to this page
draft: false
image: energy.jpg # save picture in \static\img\blogs. Acceptable formats= jpg, jpeg, or png . Your iPhone pics wont work

keywords: ""
slug: data_science # slug is the shorthand URL address... no spaces plz
...
> Question 2. Add one more variable of your own. Describe why this might be useful for differentating viewers in 1 or 2 lines.
...
```{r additional method, message=FALSE, warning=FALSE}
# uncommented code as it takes 30 min to calculate ---------------------------

# to confirm our hypothesis we conduct an additional check
# nb <- NbClust(userData_clust,
#               distance = "euclidean", 
#               min.nc = 2,
#               max.nc = 5, 
#               method = "kmeans")
...
# gap statistic
# gap_stat <- clusGap(userData_clust,
#                     FUN = kmeans,
#                     nstart = 25,
#                     K.max = 10,
#                     B = 100,
...
Answered in more detail in report
